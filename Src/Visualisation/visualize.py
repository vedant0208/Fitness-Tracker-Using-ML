...
ax[0].legend(loc="upper center", bbox_to_anchor = (0.15,1.15), ncol =3, fancybox =True, shadow = True)
ax[1].legend(loc="upper center", bbox_to_anchor = (0.15,1.15), ncol =3, fancybox =True, shadow = True)
